...
public class MainController {
    ...
    public String fizzbuzz()
    {
        ...
        System.out.println();
        return "End Value for Multiples Search: " + endValue + "<br>" + "Multiples of 7: " + String.valueOf(counter7) + "<br>" + "Multiples of 17: " + String.valueOf(counter17) + "<br>" + "Multiples of 23: " + String.valueOf(counter23) ;
